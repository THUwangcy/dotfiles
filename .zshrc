...
if [ -n "$SSH_CLIENT" ] || [ -n "$SSH_TTY" ]; then
    ...
    POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status anaconda root_indicator custom_now_playing time)
else
...
# POWERLEVEL9K_CUSTOM_NOW_PLAYING='~/.dotfiles/bin/dot'
...
POWERLEVEL9K_ANACONDA_BACKGROUND='grey23'
...
# >>> autojump >>>
[[ -s /home/wcy/.autojump/etc/profile.d/autojump.sh ]] && source /home/wcy/.autojump/etc/profile.d/autojump.sh
